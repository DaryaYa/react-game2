...
import { TETROMINOS, randomTet } from "../tetrominos";
...
export const usePlayer = () => {
  ...
  const [player, setPlayer] = useState({
	...
	const playerRotate = (stage, dir) => {
		// first we make a deep copy of our player
		...
		while(checkCollision(clonedPlayer, stage, { x: 0, y: 0 })) { // this code is from math-math methods 
